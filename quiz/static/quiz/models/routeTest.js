...
var MultiRouteTest = function(config){
    this.typeTest = config.typeTest || "";
...
MultiRouteTest.prototype.getCurrentRoute = function(receiverNum){
  return this.routes[this.questionNum][receiverNum];
};

MultiRouteTest.prototype.getScoreString = function(){
  var questionsRemaining = this.routes.length - this.questionNum - 1;
...
MultiRouteTest.prototype.restartQuiz = function(){
  //this.formations[0] ==> reset of some variety ???
  this.scoreboard.feedbackMessage = "";
  this.questionNum = 0;
  this.score = 0;
...
MultiRouteTest.prototype.advanceToNextRoute = function(message){
  this.scoreboard.feedbackMessage = message;
  this.questionNum++;
  if(this.questionNum >= this.routes.length){
    this.endTime = millis();
...
MultiRouteTest.prototype.drawQuizSummary = function() {
  var secondsElapsed = ((this.endTime - this.startTime)/1000);
  if(secondsElapsed > this.cutOff){
    secondsElapsed = this.cutOff;
  }
...
MultiRouteTest.prototype.isLastQuestion = function(){
  return this.questionNum === this.routes.length;
}
