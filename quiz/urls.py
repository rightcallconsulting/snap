...
urlpatterns = [
    ...
    url(r'^pass_zones$', views.pass_zones, name='pass_zones'),
    ...
    url(r'^qb_call_quiz$', views.QbCallQuiz.as_view(), name='qb_call_quiz'),
    ...
    url(r'^route_quiz$', views.route_quiz, name='route_quiz'),
