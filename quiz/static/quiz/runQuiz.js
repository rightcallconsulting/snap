   ...
   if(timeElapsed < 2000){
    ...
    if(clickedAssignment){
      if(hasExchanged){
        ...
        }else if(clickedAssignment.routeAfterExchange.length === 0){
          text("Click on your route after handoff exchange.", field.width / 2, (5 * field.height) / 6);
        }else{
          text("Double click to check answer.", field.width / 2, (5 * field.height) / 6);
        }
      }else{
